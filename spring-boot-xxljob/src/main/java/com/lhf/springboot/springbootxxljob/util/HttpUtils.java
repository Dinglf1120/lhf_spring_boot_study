...
public class HttpUtils {
    ...
    public static void main(String[] args) throws IOException {
        String url="http://localhost:8888/xxl-job-admin/jobinfo/add";
        CloseableHttpClient httpClient=HttpClients.createDefault();
        Map<String,String> params=new HashMap<String,String>();
        params.put("jobGroup", "1");
        params.put("jobDesc", "testay");
        params.put("executorRouteStrategy", "FIRST");
        params.put("jobCron", "0 0 0 * * ? *");


        System.out.println("start.");
        HttpPost httpPost = new HttpPost(url);
        httpPost.setHeader("Cookie", "XXL_JOB_LOGIN_IDENTITY=7b226964223a312c22757365726e616d65223a2261646d696e222c2270617373776f7264223a226531306164633339343962613539616262653536653035376632306638383365222c22726f6c65223a312c227065726d697373696f6e223a6e756c6c7d");
        // packageParam(params, httpPost);
