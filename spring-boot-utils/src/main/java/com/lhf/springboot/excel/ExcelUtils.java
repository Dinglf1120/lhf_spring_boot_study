...
public class ExcelUtils {
	...
	/*public static void main(String[] args) {
		File file = new File("C:\\Users\\Administrator\\Desktop\\service\\test.xlsx");
		try {
			InputStream input = new FileInputStream(file);
			List<String[]> vue = parseExcel(input, "xlsx", 1);
			System.out.println(com.alibaba.fastjson.JSONObject.toJSONString(vue));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}*/
